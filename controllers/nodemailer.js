...
const transporter = nodemailer.createTransport({
  service: 'Gmail',
  auth: {
    user: 'globalcodingclubkiet@gmail.com', // Replace with your email address
    pass: 'syvdmpaknkklshoy', // Replace with your email password
  },
});
...
const sendRegistrationEmail = (recipientEmail, subject, text) => {
  const mailOptions = {
    from: 'globalcodingclubkiet@gmail.com', // Replace with your email address
