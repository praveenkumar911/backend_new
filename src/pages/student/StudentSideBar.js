    ...
    return (
        <>
            <React.Fragment>
                ...
                <ListItemButton component={Link} to="/Student/assessment">
    <ListItemIcon>
        <AssessmentOutlinedIcon color={location.pathname.startsWith("/Student/assessment") ? 'primary' : 'inherit'} />
    </ListItemIcon>
    <ListItemText primary="Assessments" />
</ListItemButton>
<ListItemButton component={Link} to="/Student/addleave">
    <ListItemIcon>
        <LocalHotelOutlinedIcon  color={location.pathname.startsWith("/Student/addleave") ? 'primary' : 'inherit'} />
    </ListItemIcon>
